...
Scenario: Generated scenario
  Given I start the interview at "letter_to_request_a_grievance_heari.yml"
  And the user gets to "download letter_to_request_a_grievance_heari" with this data:
    | var | value |
    ...
    | letter_to_request_a_grievance_heari_intro | Sample answer |
    | letter_to_request_a_grievance_heari_download | Sample answer |
    | letter_to_request_a_grievance_heari_intro | True |
    | Information | True |
    | letter_to_request_a_grievance_heari_preview_question | True |
